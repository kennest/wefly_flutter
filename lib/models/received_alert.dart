...
class Properties {
  ...
  Properties.fromJson(Map<String, dynamic> json) {
    ...
    if (json['piece_join_alerte'] != null) {
      pieceJoinAlerte = new List<Piece>();
      (json['piece_join_alerte'] as List).forEach((v) {
        pieceJoinAlerte.add(new Piece.fromJson(v));
      });
    }
    asPoly = json['as_poly'];
    categorie = json['categorie'] != null
        ? new Category.fromJson(json['categorie'])
        : null;
    surface = json['surface'];
    titre = json['titre'];
    latitude = json['latitude'];
    creerPar = json['creer_par'] != null
        ? new ReceivedEmployee.fromJson(json['creer_par'])
        : null;
    if (json['destinataires'] != null) {
      destinataires = new List<ReceivedEmployee>();
      (json['destinataires'] as List).forEach((v) {
        destinataires.add(new ReceivedEmployee.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pieceJoinAlerte != null) {
      data['piece_join_alerte'] =
          this.pieceJoinAlerte.map((v) => v.toJson()).toList();
    }
    ...
    if (this.destinataires != null) {
      data['destinataires'] =
          this.destinataires.map((v) => v.toJson()).toList();
    }
